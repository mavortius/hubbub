...
<g:uploadForm action="confirmRegister" class="form-horizontal" style="max-width: 530px;" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="loginId" id="loginId" value="${user?.loginId}" type="text" class="form-control" autofocus />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="fullName" id="fullName" value="${user?.fullName}" type="text" class="form-control" autofocus />
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea name="bio" id="bio" class="form-control input-sm" rows="2" ></textarea>
        </div>
    </div>
    <div class="form-group">
